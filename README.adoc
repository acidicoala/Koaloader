...
:fn-search-dirs: search directoriesfootnote:fn-search-dirs[Search directories include the working directory of the target process as well as the directory where Koaloader DLL is located.]
